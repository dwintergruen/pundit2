angular.module('templates-main', ['src/Annomatic/AnnomaticPanel.dir.tmpl.html', 'src/Annomatic/AnnotationPopover.tmpl.html', 'src/Core/modal.login.tmpl.html', 'src/Dashboard/Dashboard.dir.tmpl.html', 'src/Toolbar/Toolbar.dir.tmpl.html']);
...
angular.module("src/Core/modal.login.tmpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("src/Core/modal.login.tmpl.html",
    "<div class=\"modal\" tabindex=\"-1\" role=\"dialog\" ng-controller=\"ModalLoginCtrl\">\n" +
