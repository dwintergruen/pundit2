...
.service('MyItemsContainer', function(ITEMSCONTAINERDEFAULTS, BaseComponent, TypesHelper) {

    var myItemsContainer = new BaseComponent('MyItemsContainer', ITEMSCONTAINERDEFAULTS);
